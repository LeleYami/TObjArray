//
// File generated by rootcint at Sat Apr 15 05:45:51 2017
...
static int G__SclassDict_168_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((const Sclass*) G__getstructoffset())->Print();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static void G__setup_memfuncSclass(void) {
   ...
   G__memfunc_setup("Print",525,G__SclassDict_168_0_2, 121, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
